<footer>
  ...
  <a href="https://github.com/jastuccio" target="_blank" rel="noreferrer noopener" class="socialLink">
    My code on GitHub
  ...
  <div><a sveltekit:prefetch href="/blog/uncopyright">Uncopyright</a> 2016 - {new Date().getFullYear()}
  Joe Astuccio</div>
