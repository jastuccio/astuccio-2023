...
const Root = (0, import_index_cba20f33.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_cba20f33.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_cba20f33.v)(components[0] || import_index_cba20f33.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_cba20f33.v)(components[1] || import_index_cba20f33.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_cba20f33.v)(components[2] || import_index_cba20f33.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_cba20f33.v)(components[1] || import_index_cba20f33.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_cba20f33.v)(components[0] || import_index_cba20f33.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<link rel="preconnect" href="https://fonts.googleapis.com">\n		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\n		<link href="https://fonts.googleapis.com/css2?family=Alegreya+Sans:wght@300;400;700&family=Exo+2:ital,wght@1,800&display=swap" rel="stylesheet">\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body>\n		<div class="sveltekit-body">' + body + "</div>\n	</body>\n</html>\n";
let read = null;
